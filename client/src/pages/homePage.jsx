...
const HomePage = () => {
    return ( 
        <div className="w-full h-screen overflow-hidden bg-no-repeat max-xl:bg-center bg-cover flex items-center justify-center md:justify-end lg:pr-12 xl:pr-20 font-roboto" style={{backgroundImage: 'url('+ HomePageBanner1 +')'}}>
